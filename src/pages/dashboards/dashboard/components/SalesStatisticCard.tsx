...
const PerformanceProgressCard = () => {
  return (
    <Card className="card">
      <CardContent className="px-0">
        <div className="flex flex-wrap items-center justify-between">
          <h6 className="mb-0 font-semibold text-lg">Performance Over Time</h6>
          <CustomSelect
            placeholder="Yearly"
        ...
        <div className="flex flex-wrap items-center gap-2 mt-2">
          <h6 className="mb-0">82% Avg Score</h6>
          <span className="text-sm font-semibold rounded-full bg-green-100 dark:bg-green-600/25 text-green-600 dark:text-green-400 border border-green-200 dark:border-green-600/50 px-2 py-1.5 flex items-center gap-1">
            5% <ArrowUp width={14} height={14} />
          </span>
          <span className="text-xs font-medium">Progress this year</span>
        </div>
